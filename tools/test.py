...
def parse_config():
    ...
    # parser.add_argument('--ckpt', type=str, default="../output/pegasus_models/cbgs_voxel0075_voxelnext/v3_coorect_ang_all_data/ckpt/checkpoint_epoch_20.pth", help='checkpoint to start from')
    parser.add_argument('--ckpt', type=str, default="../output/pegasus_models/cbgs_voxel0075_voxelnext/v4_correct_classes/ckpt/checkpoint_epoch_10.pth", help='checkpoint to start from')
